...
class TestInputs(unittest.TestCase):
    def test_match_ground_normal_given_valid_input_returns_formatted_input(self):
        input = inputs.match_ground_normal("5b")
